      ...
      <Box >
        { categoryProducts.map((product,index) => (
          ...
          <Box
            ...
            mt={20}
            mb={{base:"20", md:"2"}}
            className="px-3 ml-4  h-[40rem] relative  lg:grid lg:grid-cols-2 lg:h-[26rem] lg:w-[72%] lg:ml-28 xl2:h-[588px] w-[92%] md:ml-20 md:w-[80%]  md:h-[49rem]  xl:w-[78%] xl:h-[32rem] xl2:w-[75%] xl2:ml-[10rem] 2xl:w-[60%] 2xl:ml-64  2xl:mb-[10rem] 2xl:h-[50rem] 2xl:left-32 "
          >
            {/* Image Section */}
            <Center className={`order-${index % 2 === 0 ? '2' : ''} lg:order-${index % 2 === 0 ? '1' : '2'} 2xl:mb-8 `}>
            ...
            <Center className={`order-${index % 2 === 0 ? '0' : '1'} lg:order-${index % 2 === 0 ? '1' : '0'} mt-4 lg:mt-0 flex flex-col 2xl:ml-16 `}>
                      ...
                      <VStack flexDir={{ base: "column"}}>
                        ...
                        <Text
                          ...
                          className="w-48  text-center lg:text-[32px] lg:w-[14rem]  
                            xl:text-[32px] xl:h-[8rem] xl:w-54   xl2:w-96  lg:text-start  xl2:text-[40px] xl2:ml-64  xl2:pl-10  "
                        >
                          {product.name}
                        </Text>
              ...
              <Button className="text-white bg-orange py-2 px-4 mt-4 md:relative md:-top-20 lg:-ml-6  xl:-top-28 xl2:-ml-44" onClick={() => handleButtonClick(product.slug, product.name)}>
  See Product
</Button>
              </Link>
              </Box>
