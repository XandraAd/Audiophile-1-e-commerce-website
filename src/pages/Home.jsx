...
const Home = ({ data, handleButtonClick }) => {
  ...
  return (
    <>
   <div className="h-[600px] w-screen relative flex flex-col md:h-[600px] lg:flex-row justify-center items-center mb-0 md:mb-12 xl:h-[600px]  2xl:h-[1000px]">
   <hr   className=" relative -top-[19rem] z-20 w-full md:w-[90%] lg:w-[55rem]  xl2:w-[62rem] 2xl:w-[110rem] 2xl:-top-[31rem]"/>
    ...
    <h1 className="text-[36px] mt-6 ml-16 tracking-[4.3px] uppercase text-3xl md:text-[56px] md:ml-0  md:w-[400px] md:leading-[4rem] md:tracking-[2px] lg:ml-16  lg:w-[25rem]  font-bold  2xl:text-5xl ">
